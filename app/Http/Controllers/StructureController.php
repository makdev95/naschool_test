...
class StructureController extends Controller
{
    ...
    public function GetSchoolFee(){
        ...
        $ecolepaiment = return Http::get('http://nambongo.obac-alert.com/api/v1/ecole/paiements?ecole_id=1&debut=2020-08-11&fin=2020-10-30')->json();

        return view('Admin.paiement', compact('ecolepaiment'));
    }
}
