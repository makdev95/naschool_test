...
<div class="col-lg-12 margin-tb">
    ...
    <a class="zoomInDown mg-t" href="#" data-toggle="modal" data-target="#addprof">Ajouter un professeur</a>&nbsp;&nbsp;
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="login-horizental">
                            <button type="submit" class="btn btn-sm btn-warning login-submit-cs">Affecter la classe</button>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="form-group-inner" style="display: none;">
    ...
    @foreach ($Professeur as $structure)
     <div style="display: none;">
        <input type="text" value="{{$structure->structId}}" name="structures_id" />
     </div>
    @endforeach
<div class="row">
...
<div class="form-group">
        <label>{{ __('Créer un mot de passe') }}</label>
