...
<div class="col-lg-12 margin-tb">
    ...
    <a class="zoomInDown mg-t" href="#" data-toggle="modal" data-target="#zoomInDown1">Ajouter un niveau à une spécialité</a>
    </div>
...
<div class="row">
    <div class="form-group col-lg-12">
        <label>{{ __('Type spécialité') }}</label>
        <input id="specialite" type="text" class="form-control @error('name') is-invalid @enderror" name="specialite" value="{{ old('specialite') }}" required autocomplete="specialite" autofocus>
    </div>
...
<h1>Liste  <span class="table-project-n">Niveaux scolaires</span></h1>
</div>
</div>
...
<th data-field="email" data-editable="true">Libellé</th>
