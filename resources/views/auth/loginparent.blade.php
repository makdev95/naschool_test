...
<div class="error-pagewrap">
        <div class="error-page-int">
            ...
            <div class="content-error">
                <div class="hpanel">
                    ...
                    <form method="POST" action="{{ route('tuteur.login') }}" id="form">
                        @csrf

                        <div class="form-group">
                            <label for="email" class="control-label">{{ __('Adresse mail') }}</label>
        ...
        <div class="text-center login-footer">
                <p>Copyright © E-learning 2020 <a href="Naschool/info">Naschool</a>. All rights reserved. By <a href="#">SFARIT</a></p>
            </div>
        </div>   
    </div>
    <!-- jquery
