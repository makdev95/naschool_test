...
<div class="col-lg-12 margin-tb">
    ...
    <div class="pull-right">
        ...
        <a class="btn btn-warning" href="{{ route('Professeur.VoirCours') }}">Sujets examen</a>
...
<li class="active"><a href="#description">Examens</a></li>
...
<div class="row">
    ...
    <div class="form-group col-lg-12">
        <label>{{ __('Nom de l'examen) }}</label>
