	...
	<div class="error-pagewrap">
		<div class="error-page-int">
			<div class="text-center m-b-md custom-login">
				<h3>NASCHOOL Super Administrateur</h3>
                    ...
                    <div class="panel-body">
                        ...
                        {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Nom utilisateur" title="Votre nom utilisateur svp" required="" value="" name="email" id="email" class="form-control" required autofocus>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="password">Créer un mot de passe</label>
                                <input type="text" title="Please enter your password" placeholder="******" required="" value="" name="password" id="password" class="form-control">
                                <span class="help-block small"></span>
                            </div>
                            <button class="btn btn-success btn-block loginbtn">Terminer</button>
