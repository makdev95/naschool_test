...
<div class="col-lg-12 margin-tb">
    ...
    <a class="zoomInDown mg-t" href="#" data-toggle="modal" data-target="#addprof">Ajouter un stagiaire</a>&nbsp;&nbsp;
    </div>

    &nbsp;&nbsp;&nbsp;&nbsp;
    <div class="pull-right">
        <a class="btn btn-primary" href="">Les stagiaires</a>
    </div>
...
<li><a href="#other"> Stagiaire info</a></li>
</ul>
...
<div class="form-group-inner" style="display: none;">
    ...
    <select class="form-control custom-select-value" name="role">
     ...
     <div style="display: none;">
        <input type="text" value="0" name="structures_id" />
     </div>
<div class="row">
<div class="form-group col-lg-6">
